...
set "CFG=D:\ai-github\cc-connect\instances\instance-c\rigthcode.toml"

echo [INFO] Starting instance-c with provider: rightcode
...
"%EXE%" -config "%CFG%"
set "RC=%ERRORLEVEL%"
echo [EXIT] instance-c(rightcode) exited with code %RC%
exit /b %RC%

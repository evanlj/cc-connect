...
set "CFG=D:\ai-github\cc-connect\instances\instance-c\codez.toml"

echo [INFO] Starting instance-c with provider: codez
...
"%EXE%" -config "%CFG%"
set "RC=%ERRORLEVEL%"
echo [EXIT] instance-c(codez) exited with code %RC%
exit /b %RC%

...
set "CFG=D:\ai-github\cc-connect\instances\instance-a\codez.toml"

echo [INFO] Starting instance-a with provider: codez
...
"%EXE%" -config "%CFG%"
set "RC=%ERRORLEVEL%"
echo [EXIT] instance-a(codez) exited with code %RC%
exit /b %RC%
